...
if ARGV.length != 1
    puts "Usage: ruby lucky_for_life.rb <base_directory>"
    exit
end
...
request["cookie"] = 'PHPSESSID=8e8k65rm3q412abggmf222scj4; exp_last_visit=1245388732; exp_last_activity=1560748732; exp_csrf_token=cbfffc7e5ded658d573d517c5d9ce5217d4bcc7f'
